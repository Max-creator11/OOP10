...
class Groups:
    ...
    def person_fullname(self):
        return'{},{}; Group:{}; Stipend:{}'.format(self.last, self.first, self.group, self.stipend)

    @person_fullname.setter
    def person_fullname(self, name):
        first, last = name.split(' ')
        self.first = first
        self.last = last

    @person_fullname.deleter
    def person_fullname(self):
...
# print(student3.first)
# student3.first = "Ivan"

student3.person_fullname = "Bohdan Sirko"
print(student3.person_fullname)
del(student3.person_fullname)
print(student3.person_fullname)
